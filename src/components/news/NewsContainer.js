...
const SAVE_NEWS_ACTION = 'news/SAVE_NEWS_ACTION';
...
const newsReducer = (state = initialState, action) =>
  ...
  action.type === SAVE_NEWS_ACTION ? ({ ...state, news: action.news }) :
  state;

// Action Creators
export const saveArticle = article => ({ type: SAVE_ARTICLE, article });
export const saveNewsAction = news => ({ type: SAVE_NEWS_ACTION, news });
